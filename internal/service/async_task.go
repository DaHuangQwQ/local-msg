...
import (
	...
	"errors"
	"fmt"
	"github.com/DaHuangQwQ/local-msg/internal/dao"
	"github.com/DaHuangQwQ/local-msg/internal/errs"
	"github.com/DaHuangQwQ/local-msg/internal/msg"
	"github.com/DaHuangQwQ/local-msg/internal/sharding"
	"github.com/DaHuangQwQ/redis-lock"
...
func (task *AsyncTask) refreshAndLoop(ctx context.Context, lock redis_lock.Lock) {
	// 这里有两个动作：
	// 1. 执行异步补偿任务，
